...
class MainFrame:
    ...
    def create_interface(self):
        ...
        self.send_button = tk.Button(self.root, text="Invia", command=self.chat_domanda)
    ...
    def set_animale(self, animale, popup):
        ...
        popup.destroy()
        self.aggiungi_messaggio(f"Stai parlando con {animale}.", lato="left", colore_bordo="#6D96FF", bg="#444")
    ...
    def chat_domanda(self):
        ...
        self.aggiungi_messaggio(f"You: {domanda}", lato="right", colore_bordo="#777777", bg="#333")
    ...
    def aggiungi_messaggio(self, testo, lato="left", colore_bordo="blue", bg="#222"):
